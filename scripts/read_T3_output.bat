...
REM ----------------------------
set OID_INDEX=1.3.6.1.4.1.50523.1.2.0
set OID_CFGTYPE=1.3.6.1.4.1.50523.1.2.1
set OID_ANALOG=1.3.6.1.4.1.50523.1.2.2
set OID_BINARY=1.3.6.1.4.1.50523.1.2.3
set OID_DESC=1.3.6.1.4.1.50523.1.2.4
set OID_UNIT=1.3.6.1.4.1.50523.1.2.5
