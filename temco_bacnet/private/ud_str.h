...
typedef enum
{
	OUT  = 0, IN            , VAR           , CON        , WRT    , AR, PRG, TZ = 8,
...
typedef enum
{
	OUTPUT=1, INPUT, VARIABLE, CONTROLLER, WEEKLY_ROUTINE,
...
{
	not_used_input,
	Y3K_40_150DegC,Y3K_40_300DegF,/*PT100_40_1000DegC, PT100_40_1800DegF,*/ R10K_40_120DegC,
