 ...
 */
extern uint8_t far mtu[MAX_MPDU_IP];
...
//    fd_set read_fds;	   chelsea
    int max = 0;
//    struct timeval select_timeout;	 chelsea
...
//        len = 6;
				encode_unsigned16(&pdu[2], 10); // changed by chelsea
        encode_unsigned16(&pdu[4], 100);
        len = 10;  // changed by chelsea
    }
