...
// HY3131 is excluded from this ES51932 build.
...
void watchdog_init(void)
{
		...
		/* Nominal timeout: (40 kHz LSI / 32), 3750 counts = 3 s. */
		IWDG_SetPrescaler(IWDG_Prescaler_32);
		/* Reload must fit the 12-bit IWDG counter. */
		IWDG_SetReload(3749);
...
//	xTaskCreate( vINPUTSTask, ( signed portCHAR * ) "INPUT", configMINIMAL_STACK_SIZE + 200, NULL, tskIDLE_PRIORITY + 2, NULL );
	...
	vStartKeyTasks(tskIDLE_PRIORITY + 4);
