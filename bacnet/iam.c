...
//#if BAC_MASTER			
//			// add panel number by chelsea
//			if(i % 2)
//			{
//			 apdu[apdu_len] = panel_number; 
//			 apdu_len += 1;
//			}
//#endif
    }
    ...
    uint16_t * pVendor_id)
{
    int far len = 0;
    int far apdu_len = 0;   /* total length of the apdu, return value */
    uint16_t far  object_type = 0;   /* should be a Device Object */
    uint32_t  far object_instance = 0;
