...
enum {
	...
	MODBUS_LED_TEST_FOR_PLC = 96, // ONLY FOR PLC ？？？？？ no used
	...
	MODBUS_SHT4X_EXIST,//745
	MODBUS_SCD4X_EXIST,//746
	MODBUS_INTERNAL_TEMP,//747
...
//	uint8_t	network_number; // networknumber, when first bit is 0
	...
	// ONLY FOR PLC RMC1232
	MODBUS_CT1_CHANNEL = 1000,
	MODBUS_CT2_CHANNEL,
	MODBUS_CT3_CHANNEL,
	MODBUS_CT4_CHANNEL,
	MODBUS_CT5_CHANNEL,
	...
	MODBUS_POWER_EN1 = 1010,
	MODBUS_POWER_EN24 = 1010 + 23,	
	MODBUS_ENERGY1 = 1050,  // after MODBUS_POWER_EN24, 2 regs per uint32
	MODBUS_ENERGY24 = MODBUS_ENERGY1 + 46,	// 1096 1097
	
	MODBUS_BATTERY1 = 1100,
	MODBUS_BATTERY7 = 1106,
	MODBUS_BATTERY_SUM = 1107,
	MODBUS_CUVT,
	MODBUS_COVT,
	MODBUS_SHUTDOWN_CELL,	/* POWER_SHUTDOWN_CELL_MV (mV) */
	MODBUS_OC_CHG,		/* POWER_OC_CHG_MA (mA) */
	MODBUS_OC_DSG,		/* POWER_OC_DSG_MA (mA) */
	MODBUS_BMS_COMM,
	MODBUS_48V_EXIST,
	MODBUS_BMS_CURRENT, //1115
	...
	MODBUS_HUM2 = 1203,
	MODBUS_VOL_IN9 = 1204,
	MODBUS_VOL_IN10 = 1205,
	MODBUS_VOL_IN11 = 1206,
...
//	MODBUS_PM25_OFF_TIME,
	...
	MODBUS_AIRLAB_DISPLAY_CONFIG2 = BASE_AIRLAB + 1957,
...
//	MODBUS_CO2_MENU_BLOCK_SECONDS = BASE_CO2 + 1261,		// 1261
	...
	MODBUS_CO2_SCREEN_AREA_1 = BASE_CO2 + 3134, //55134
