...
#define MAX_AIS  19//64 //17 //11
#define MAX_INS			19//64
#define MAX_OUTS		64
#define MAX_VARS				128
...
enum {
  ...
  PREVIOUS_BAUDRATE,//110						// 0	1	Baudrate 0 = 9.6kb/s, 1 = 19.2kb/s
	...
	CALIBRATION_ANALOG7,//
	CALIBRATION_ANALOG8,//
	INFRARED_TEMP_1 ,       //		    //  sensor frequency	   //these parameters must be continued,it won't work  if have blank,don't know why
	INFRARED_TEMP_2	,          //				//  calibration point
	TSTAT_HUMCOUNT2_H ,       //			//
	TSTAT_HUMRH2_H	,          //
	ANALOG1_FUNCTION,//
	ANALOG2_FUNCTION,//
  ...
  SPECIAL_MENU_LOCK,//				// 0	1	Special menu lockout via keypad, serial port only 0=unlock, 1=lock
	...
	MODBUS_SOUND_TRIGGER,//UNIVERSAL_OFF_TABLE_BEGIN , //PID2 ON/OFF mode off tabale
	MODBUS_SOUND_TIMER,//UNIVERSAL_OFF_TABLE_COOL1 ,
	MODBUS_SOUND_ALARM_ON,//UNIVERSAL_OFF_TABLE_COOL2 ,
	MODBUS_SOUND_COUNT_DOWN,//UNIVERSAL_OFF_TABLE_COOL3 ,
	MODBUS_LIGHT_TRIGGER,//UNIVERSAL_OFF_TABLE_HEAT1 , //
	MODBUS_LIGHT_TIMER,//UNIVERSAL_OFF_TABLE_HEAT2 ,
	MODBUS_LIGHT_ALARM_ON,//UNIVERSAL_OFF_TABLE_HEAT3 ,
	MODBUS_LIGHT_COUNT_DOWN,//UNIVERSAL_OFF_VALVE_BEGIN , //PID2 valve mode off tabale
	MODBUS_CO2_TRIGGER,//UNIVERSAL_OFF_VALVE_COOL1 ,
	MODBUS_CO2_TIMER,//UNIVERSAL_OFF_VALVE_COOL2 ,
	MODBUS_CO2_ALARM_ON,//UNIVERSAL_OFF_VALVE_COOL3 ,
	MODBUS_CO2_COUNT_DOWN,//UNIVERSAL_OFF_VALVE_HEAT1 ,
	...
	MODBUS_OCC_TRIGGER,//UNIVERSAL_VALVE_BEGIN_1,
	MODBUS_OCC_TRIGGER_TIMER,//UNIVERSAL_VALVE_BEGIN_2,
	MODBUS_OCC_ALARM_ON,//UNIVERSAL_VALVE_BEGIN_3,
	MODBUS_OCC_COUNT_DOWN,//UNIVERSAL_VALVE_HEAT1 ,
