...
const S32_T code tab_int[10] = { 11875, 21375, 10000, 18000, 10000, 18000,10000, 18000, 10000, 18000 };

const S32_T code limit[10][2] = { { -40000L, 150000L }, { -40000L, 302000L },
...
const uint16_t code def_tab_10bit[5][17] = {
...
const uint16_t code def_tab_12bit_PT1K[51] = 
{
...
const uint16_t code def_tab_12bit[5][17] = {
 /* 3k termistor YSI44005 -40 to 150 Deg.C or -40 to 302 Deg.F */
