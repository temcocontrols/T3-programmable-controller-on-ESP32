...
/* Undefine conflicting macros from types.h */
#undef u8
#undef u16
#undef u32
...
{
    debug_info("Toggle button pressed");
...
esp_err_t app_driver_light_set_defaults(uint16_t endpoint_id)
{
    ...
    if (val.val.u8 == (uint8_t)ColorControl::ColorMode::kCurrentHueAndCurrentSaturation) {
        ...
        debug_info("Color mode not supported");
    }
...
app_driver_handle_t app_driver_light_init()
{
    ...
    return NULL;  /* TODO: Implement led_driver initialization */
}
...
app_driver_handle_t app_driver_button_init()
{
    ...
    //     debug_info("Failed to create button device");
    //     return NULL;
    // }
    //
    // iot_button_register_cb(handle, BUTTON_PRESS_DOWN, NULL, app_driver_button_toggle_cb, NULL);
    // return (app_driver_handle_t)handle;
    return NULL;  /* TODO: Implement button driver initialization */
}
